...
public class IntegerStorage {
     ...
     * which holds a copy of the {@link IntegerStorage#observers}.
     */
    private List<IntegerStorageObserver> newObservers;

    /**
     * Creates a new instance of this object with an initial value.
     *
    ...
    public void setValue(int value) {
        ...
        newObservers = new ArrayList<>(observers);

        if (newObservers != null) {
            for (IntegerStorageObserver observer : newObservers) {
